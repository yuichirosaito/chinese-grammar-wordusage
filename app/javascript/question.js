...
//2級
    ...
    //4級
    {
      ...
      answer: "得",
      explain: "ある動作の様態を表す補語は「得」と共にを用いる。本門は「快」が「跑」を形容している形なので「得」が適当"
    },
    {
      text: "她有五（？）钢笔。",
      choice: ["本","对","支","块",
    ...
    },
    {
      ...
      answer: "吧",
      explain: "「吧」は「〜したらどうですか」のような提案や命令を意味する助詞。本門はよく休むことを提案する文なので「吧」が適当"
    },
    {
      text: "你喝酒了，今天不（？）开车。",
      choice: ["能","会","得","行",
    ...
    },
    {
      ...
      answer: "完",
      explain: "結果補語の否定は「没」であること、また「まだご飯を食べていない」という文脈から「終える」を意味する「完」が適切"
    },
    {
      text: "你们非常努力（？）学习。",
      choice: ["呢","得","了","地",
      ...
      answer: "地",
      explain: "「地」は後方の動詞や形容詞を就職する際に用いられる助詞。今回の場合、「努力」でどのように学習しているかを形容しているので「地」が適当"
    },
  ];
